...
This directory contains the source-of-truth project documents for `ghawb`.
...
- [sprint_backlogs/sp4.md](./sprint_backlogs/sp4.md): Sprint 4 backlog record, planning notes, and committed items.
...
- [sprint_backlogs/sp9.md](./sprint_backlogs/sp9.md): Sprint 9 backlog record, planning notes, and committed items.
...
- [LEARN.md](./LEARN.md): Durable lessons, pitfalls, and implementation notes.
- [sprint_reviews/sp1.md](./sprint_reviews/sp1.md): Sprint 1 review summary, demo scope, findings, and reprioritization outcome.
- [sprint_reviews/sp2.md](./sprint_reviews/sp2.md): Sprint 2 review summary, demo scope, findings, and Product Owner follow-up decision.
...
- `docs/SPEC.md` is the current specification source of truth.
- `docs/adrs/` stores architecture decision records using the `NNNN-short-kebab-case.md` naming convention.
- Update this index whenever a new `docs/**/*.md` file is added.
