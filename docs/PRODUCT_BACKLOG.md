...
- Sprint 26 retrospective decision: The next product follow-up should preserve the additive helper boundary and keep the package-adoption path short and ordered. The shipped increment already makes the CLI contract clearer, so future product intake should favor narrow ergonomics and onboarding refinements over broader surface growth. See [Sprint 26 Retrospective](./sprint_retrospectives/sp26.md).
