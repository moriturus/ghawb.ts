...
- (Reconfirmed during Sprint 26 retrospective) Keep the sprint-review and retrospective evidence path explicit enough that reviewers can compare maintained docs, backlog wording, and shipped behavior without hunting through multiple files.
