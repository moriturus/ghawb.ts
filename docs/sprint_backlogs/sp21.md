...
Status: in progress — 1/3 items completed (3/9 SP); remaining items ready.
...
- Status: ready
- Completed At: N/A
- Notes/Links: Moved from the active product backlog into Sprint 21 as the second hardening-oriented item after workflow-definition modernization. Planned primary implementer: Mio Kanda. Planned reviewer: Haru Nishimura.
