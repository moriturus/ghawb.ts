...
Status: ready — 3 items committed (9 SP).
...
- Status: ready
- Completed At: N/A
- Notes/Links: Moved from the active product backlog into Sprint 21 after the Sprint 20 hardening-first reprioritization. Planned primary implementer: Mio Kanda. Planned reviewer: Haru Nishimura.
