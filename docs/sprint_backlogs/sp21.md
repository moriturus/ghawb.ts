...
Status: in progress — 2/3 items completed (6/9 SP); remaining items ready.
...
- Status: ready
- Completed At: N/A
- Notes/Links: Moved from the active product backlog into Sprint 21 only after the two hardening-oriented items. Planned primary implementer: Yui Morita. Planned reviewer: Aoi Sakamoto.
