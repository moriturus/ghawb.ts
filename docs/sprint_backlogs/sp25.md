...
- Story Points: 2
- Status: done
- Completed At: 2026-04-05T17:12:30Z
- Notes/Links: Intake created from Product Owner product discovery. Delivered through PR [#104](https://github.com/moriturus/ghawb.ts/pull/104) into `sprint-25` after docs consistency review, `git diff --check`, and stale-pattern verification across README / Cookbook / API Reference / SPEC. Evidence: [Sprint 23 Review](../sprint_reviews/sp23.md), [README](../../README.md), [Cookbook](../COOKBOOK.md), and [API Reference](../API_REFERENCE.md).
...
- Story Points: 3
- Status: done
- Completed At: 2026-04-05T17:19:37Z
- Notes/Links: Intake created from Product Owner product discovery. Delivered through PR [#105](https://github.com/moriturus/ghawb.ts/pull/105) into `sprint-25` after `bun run verify:docs`, targeted docs/example guardrail tests, and `bun run check`. Evidence: [Sprint 23 Review](../sprint_reviews/sp23.md), [Sprint 23 Retrospective](../sprint_retrospectives/sp23.md), and [Contributing](../CONTRIBUTING.md).

## Sprint Closeout

- Sprint review note: [docs/sprint_reviews/sp25.md](../sprint_reviews/sp25.md)
- Sprint retrospective note: [docs/sprint_retrospectives/sp25.md](../sprint_retrospectives/sp25.md)
- Sprint closeout PR: [#106](https://github.com/moriturus/ghawb.ts/pull/106)
- Sprint closeout merge date: 2026-04-06
- Closeout note: The merged Sprint 25 increment includes a follow-up CLI contract refinement on top of the committed items: render-plan manifests now use `--bulk`, while `--config` is the per-target render-time injection path exposed through `getRenderConfig<T>()`. Review and retrospective notes record the resulting product and process follow-ups.
